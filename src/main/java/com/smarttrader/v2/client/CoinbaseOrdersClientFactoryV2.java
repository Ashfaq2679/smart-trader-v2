 ...
 *
 * Separate from CoinbaseClientFactoryV2 (which builds the plain WebClient used for the
...
public class CoinbaseOrdersClientFactoryV2 {

    private final CoinbaseProperties properties;
    private volatile OrdersService cached;

    public CoinbaseOrdersClientFactoryV2(CoinbaseProperties properties) {
